...
const TaskItem = ({ item, index }) => {
    ...
    const handleFinished = () => {
        ...
        const newData = reorderData(tasks, index, newItem)
                ...
                <div className="w-full p-2 rounded-lg bg-white">
                    <div className=" flex justify-between items-center  ">
                        ...
                        <div className="flex items-center gap-2  ">
                            <div className="cursor-pointer" onClick={handleFinished}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={`${item.isFinished ? 'rgba(255, 0, 0, 0.5)' : 'rgba(0, 0, 0, 0.4)'}`} className="w-8 h-10 ">
